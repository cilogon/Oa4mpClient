<?php
/**
 * COmanage Registry Oa4mp Client Plugin Claim View
 *
 ...
 */
  ...
  $claims = $this->request->data['Oa4mpClientClaim'];

  if(file_exists(APP . "Plugin/" . $this->plugin . "/View/Oa4mpClientClaims/tabs.inc")) {
    include(APP . "Plugin/" . $this->plugin . "/View/Oa4mpClientClaims/tabs.inc");
  } elseif(file_exists(LOCAL . "Plugin/" . $this->plugin . "/View/Oa4mpClientClaims/tabs.inc")) {
    include(LOCAL . "Plugin/" . $this->plugin . "/View/Oa4mpClientClaims/tabs.inc");
  }
?>
...
<table id="oa4mp_client_co_claims" class="ui-widget">
  <thead>
    <tr class="ui-widget-header">
      <th><?php print _txt('ct.oa4mp_client_co_claims.1'); ?></th>
