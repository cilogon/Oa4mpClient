...
class Oa4mpClient extends AppModel {
  ...
  public function cmPluginMenus() {
    return array(
      "cmp" => array(
        _txt('pl.oa4mp_client.menu.cmp') => array('controller' => 'oa4mp_client_co_admin_clients', 'action' => 'index')
      ),
      "coconfig" => array(
        _txt('pl.oa4mp_client.menu.coconfig') => array('controller' => 'oa4mp_client_co_oidc_clients', 'action' => 'index')
      )
    );
  }
}
