<?php
/**
 * COmanage Registry Oa4mp Client Plugin Refresh Token Model
 *
...
class Oa4mpClientRefreshToken extends AppModel {
  // Define class name for cake
  public $name = "Oa4mpClientRefreshToken";
  ...
  public $displayField = "token_lifetime";
