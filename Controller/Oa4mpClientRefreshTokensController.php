...
class Oa4mpClientRefreshTokensController extends StandardController {
  ...
  function manage() {
    ...
    if($serverExtra !== $currentExtra) {
      $this->Oa4mpClientRefreshToken->Oa4mpClientCoOidcClient->id = $clientId;
      $this->Oa4mpClientRefreshToken->Oa4mpClientCoOidcClient->saveField('oa4mp_server_extra', $serverExtra);
